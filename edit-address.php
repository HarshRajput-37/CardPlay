<?php
  ...
  $sql = "UPDATE user SET address = '{$address}' WHERE idUsers = {$userid}";

    if(mysqli_query($conn,$sql)){
      header("Location: {$hostname}/address.php");
    }
  }
?>
<!DOCTYPE html>
...
<div class="banner_top innerpage" id="home">
  ...
  <div class="container-fluid display-table">
        <div class="row display-table-row">
          ...
          <div class="row">
              <div class="col-md-12">
                  <h1 class="admin-heading">Update User Address</h1>
              </div>
                ...
                ?>
                  ...
                  <form  action="<?php $_SERVER['PHP_SELF']; ?>" method ="POST">
                      <div class="form-group">
                          <input type="hidden" name="user_id" class="form-control" value="<?php echo $_SESSION["userId"]; ?>">
                      </div>
                      <div class="form-group">
                          <label>Address</label>
