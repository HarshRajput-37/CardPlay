...
<div class="banner_top innerpage" id="home">
		...
		<div class="services-breadcrumb_w3ls_agileinfo">
			<?php
                    include "includes/dbh.php";
                    $ct_id = $_GET['cid'];
                    $query = "SELECT * FROM product_categories WHERE product_categories.category_id = {$ct_id}";
				...
				<div class="wrapper_top_shop">
					...
					<?php
                        ...
                        if(isset($_GET['cid'])){
			            	...
			            	$sql1 = "SELECT * FROM product_categories WHERE category_id = {$cat_id}";
							...
							<div class="product-card-info card">
								<div class="men-pro-item">
									<div class="men-thumb-item">
										...
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href='single.php?id=<?php echo $row['product_id'];?>&&cid=<?php echo $row['category_id'];?>' class="link-product-add-cart">Quick View</a>
											</div>
										</div>
									...
									<div class="item-info-product">
										<h4>
											<a href='single.php?id=<?php echo $row['product_id'];?>&&cid=<?php echo $row['category_id'];?>'><?php echo $row['product_name'];?></a>
										</h4>
