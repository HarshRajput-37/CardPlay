                        ...
                        <?php
                          if(isset($_POST['login'])){
                            ...
                            if(empty($_POST['username']) || empty($_POST['password'])){
                              ...
                              $sql = "SELECT idDealer, didDealer, role FROM dealer WHERE didDealer = '{$username}' AND pwdDealer= '{$password}'";
                              ...
                              if(mysqli_num_rows($result) > 0){
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                  session_start();
                                  $_SESSION["username"] = $row['didDealer'];
                                  $_SESSION["user_id"] = $row['idDealer'];
