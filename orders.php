        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    ...
                    <div class="address_form" style="margin-bottom: 30px;">
							<section class="creditly-wrapper wrapper">
									...
									<div class="first-row form-group">
										...
										<div class="controls" style="margin-left: 30px;margin-bottom: 10px;">
											<h4>Full name : <span><?php echo $row['name'];?></span></h4>	
										</div>
										...
										<div class="controls" style="margin-left: 30px;margin-bottom: 10px;">
											<h4>Address provided : <span><?php echo $row['address'];?></span></h4> 
										</div>
										<div class="controls" style="margin-left: 30px;margin-bottom: 10px;">
											<h4>Payment mode : <span><?php echo $row['paymode'];?></span></h4> 
										</div>
										<div class="controls" style="margin-left: 30px;margin-bottom: 10px;">
											<h4>Products ordered : <span><?php echo $row['products'];?></span></h4> 
										</div>
										<div class="controls" style="margin-left: 30px;margin-bottom: 30px;">
											<h4>Total ammount paid : <span> &#8377; <?php echo $row['ammount_paid'];?></span></h4> 
										</div>
